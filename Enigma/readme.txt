...
To play around with it, import the project and run it from main. A command line interface (or, use the Swing GUI) will show up asking for
...
I had no time to hack together a fancier GUI also.
